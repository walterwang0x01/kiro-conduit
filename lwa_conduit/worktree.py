...
- 每个 worktree 一个独立分支：`lwa-conduit/<task-id>`
...
from lwa_conduit.paths import BRANCH_PREFIX, conduit_dir
...
class WorktreeManager:
    ...
    def __init__(
        ...
        self._root = (
            ...
            else conduit_dir(base_repo) / WORKTREE_SUBDIR
        )
    ...
    async def create(
        ...
        *,
        ...
        reuse_branch=False（默认）：基于 base_branch 新建分支 lwa-conduit/<task_id>。

...
class Verifier:
    ...
    def __init__(
        ...
        *,
        ...
        from lwa_conduit.semantic import NoOpSemanticReviewer, SemanticReviewer  # noqa: F401
    ...
    async def _run_semantic_layer(
        ...
        from lwa_conduit.semantic import ReviewContext, run_with_timeout
    ...
    def _run_contract_layer(self, cwd: Path) -> LayerResult:
        ...
        from lwa_conduit.contracts import diff_signatures, extract_signatures
